    ...
    let intentParams = [
        
        {
            ...
            "sampleUtterances": [
                ...
                "I want to order dinner to takeout",
            ...
            "slots": [
                ...
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "What drink do you want to add in this order?",
                                "contentType": "PlainText"
                            }
                        ]
                    }
                ...
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "When do you want to schedule the pickup?",
                                "contentType": "PlainText"
                            }
                        ]
                    }
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "258234c9",
